...
const AboutUs = () => {
  ...
  return (
    <div className="container py-4">
      <AboutUsModal show={aboutUsModalState} hide={()=>setAboutUsModalState(false)} personName={personName} personDesc={personDesc} personRole={personRole} />
                ...
                <div className="row my-3">
                  <div className="col d-flex justify-content-center">
                    <div
                      ...
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Ambrose Ling","Developer & Project Leader",ambrose_desc)}
                  ...
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Eric Li","Developer",eric_desc)}
                    >
                  ...
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Sahil Amin","Developer",sahil_desc)}
                    >
                ...
                <div className="row my-3">
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Andrew Abdel Malak","Develop & Hardware Engineer",andrew_desc)}
                    >
                      <img
                        src={andrew_pic}
                        className="card-img-top"
                  ...
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Andrew Abdel Malak","Develop & Hardware Engineer",arman_desc)}
                ...
                <div className="row my-3">
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Jayson Cheung","Business Operations Manager",jayson_desc)}
                  ...
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Abaidullah Arif","Business Operations & Marketing",abaidullah_desc)}

                    >
                      <img src={abaidullah_pic} className="card-img-top" alt="..." />
                      <div className="card-body">
                      <h4
                          className="text-primary"
                          style={{ textAlign: "center" }}
                  ...
                  <div className="col d-flex justify-content-center">
                    <div
                      className="aboutus-card card"
                      style={{ width: "18rem" }}
                      onClick={()=>handleAboutUsModal("Nico Ling","Business Operations & Finanial Supervisor",nico_desc)}
